...
SRC_URI="
amd64? ( 
	http://download.spotify.com/preview/spotify-client_${PV}.ga1569aa.552-1_amd64.deb 
)
x86?   (
	http://download.spotify.com/preview/spotify-client_${PV}.ga1569aa.552-1_i386.deb
)"
